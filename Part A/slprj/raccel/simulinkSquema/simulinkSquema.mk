...
MODEL               = simulinkSquema
MODULES             = rt_logging.c rtGetInf.c rtGetNaN.c rt_nonfinite.c simulinkSquema_capi.c simulinkSquema_data.c simulinkSquema_tgtconn.c rt_logging_mmi.c rtw_modelmap_utils.c
MAKEFILE            = simulinkSquema.mk
...
MASTER_ANCHOR_DIR   = 
START_DIR           = C:/Users/Vian/DOCUME~1/MATLAB/ASSIGN~3/PARTA~1
...
MODELLIB                  = simulinkSquemalib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = simulinkSquema_ref.rsp
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/simulinkSquema \
